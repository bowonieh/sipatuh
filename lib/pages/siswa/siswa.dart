...
class _SiswaState extends State<Siswa> {
  ...
  void fetchDataSiswa(String query) async {
    ...
    try {
      final dynamic apiUrl = Uri.parse(Constants.baseUrl + Constants.siswaapi+'$query');
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              Icon(
                                jenkel == 'L' ? Icons.male : Icons.female,
                                color: jenkel == "L" ? Colors.white : Colors.red,
                                size: 24,
                              ),
                              Expanded(
                                flex: 1,
